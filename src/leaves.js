...
xhr.open("GET", "http://erp.xeamventures.com/api/v1/departments");
...
xhr.open("POST", "http://erp.xeamventures.com/api/v1/user-attendance-detail");
...
time_conditional=(t)=>{
  if(t ==""){
    ...
    render (){
       const {final_data,language,final_data_sec,tvf,tvl,language_sec,data,counter_data,pic_name_data,emp_code}=this.state;
...
/>
            ...
            <TouchableOpacity style={styles.button} onPress={()=>this.show_four()}>
              ...
              <Text style={{left:20,bottom:0,color:'white'}}>Search</Text>
