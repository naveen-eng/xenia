  ...
  conditional=(t)=>{
    ...
    if(t=="Approved"){
     ...
     render (){
       ...
       <View style={{width:'20%',height:'4%',bottom:'6%',left:'0%',flexDirection:'row',alignItems:'center',justifyContent:'center',}}>
       {Options.map((item) => {
       return (
         ...
         <View style={{bottom:'2%',margin:'1.5%',left:'20%'}}>
   ...
   const styles = StyleSheet.create({
     Approve:{ backgroundColor:'#78b341',borderRadius:10,height:20,width:20,color:'white',fontSize:15,overflow: "hidden",top:'0%'},
     In_Progress:{ backgroundColor:'#cc6600',borderRadius:10,height:20,width:20,color:'white',fontSize:15,overflow: "hidden"},
     Rejected:{ backgroundColor:'#c11418',borderRadius:10,height:20,width:20,color:'white',fontSize:15,overflow: "hidden"},
     Cancelled:{ backgroundColor:'#adadad',borderRadius:10,height:20,width:20,color:'white',fontSize:15,overflow: "hidden"},
